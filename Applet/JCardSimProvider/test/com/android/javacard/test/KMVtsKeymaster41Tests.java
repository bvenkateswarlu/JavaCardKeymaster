...
public class KMVtsKeymaster41Tests extends KMFunctionalBaseTest {
	...
	public void testNewKeyGeneration_Rsa() {
		KMKeyParameterSet.KeyParametersSetBuilder builder = 
				new KMKeyParameterSet.KeyParametersSetBuilder();
		...
		KMKeyCharacteristicsSet keyChars = 
				KMKeyCharacteristicsSet.decodeKeyCharacteristics(keyCharacteristicsPtr);
		...
		KMKeyCharacteristicsSet keyCharsNew = 
				KMKeyCharacteristicsSet.decodeKeyCharacteristics(keyCharacteristicsPtr);
		Assert.assertTrue(keyChars.compare(keyCharsNew));
		

		Assert.assertEquals(2048, keyCharsNew.getHwParameterSet()
